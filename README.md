...
The imagewas generated by `buildroot v2022.11` which was specially patched to support Lichee dock. The size of the unpacked image is ca. 99MB. There is 20MB free space for you initially. The rest is used by the system.
